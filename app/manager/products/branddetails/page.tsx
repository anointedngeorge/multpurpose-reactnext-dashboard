...
const Tiles:React.FC<TilesInterface> = (prop) => {
    ...
    return (
        <div className="flex flex-row shrink-0">
            ...
            <div><Link className="btn btn-ghost btn-circle"  onClick={prop?.edititem} href={{pathname:'/manager/products/productlisting/', query:{id:`${prop?.data?.id}`, name:`${prop?.data?.data?.name}` }}}><BsFillEyeFill size={25} /></Link></div>
