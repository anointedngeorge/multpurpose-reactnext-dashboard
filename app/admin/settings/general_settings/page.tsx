                ...
                <form action={action} >
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className='row-span-1'>
                            ...
                            <input defaultValue={ssrdata?.instagram} type="text" placeholder="Instagram" name='instagram' className="input input-bordered w-full" />  
                        </div>

                        <div className='row-span-1'>
                            <label  >Telegram</label><br />
                            <input defaultValue={ssrdata?.telegram} type="text" placeholder="telegram" name='telegram' className="input input-bordered w-full" />  
                        </div>

                        <div className='row-span-1'>
                            <label  >Whatsapp</label><br />
                            <input defaultValue={ssrdata?.whatsapp} type="text" placeholder="whatsapp" name='whatsapp' className="input input-bordered w-full" />  
                        </div>
