...
import  {staffsignup}  from "@/app/actions/auth";
...
export default function Home() {
    const {state, action, status, EnumMessage} = useCustomActionState({fn:staffsignup})
        ...
        <div className="w-1/2 max-sm:w-auto drop-shadow-lg lg:bg-gray-100 rounded-lg p-8">
            <div className="flex flex-col place-content-center items-center space-y-10">
                <div className="text-center">
                    ...
                    <p><strong><b>Staff Dashboard Login</b></strong></p>
                </div>
                <div >
                    <form action={action} >
